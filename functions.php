...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('aka-style', get_template_directory_uri() . '/css/style.css?version=234144644455654586444864576789701234');
});
...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script('theme-menu', $theme_js_path . 'menu.js?version=614446444655', [], null, true);
    wp_enqueue_script('theme-navigation', $theme_js_path . 'navigation.js?version=255444748686454444787555', [], null, true);
